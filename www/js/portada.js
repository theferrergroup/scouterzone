$(document).on("pageshow","#portada",function(event, ui){
    ...
    $.ajax({
        ...
        beforeSend:function(){
            ...
            if(respuesta=="Undefined Sports Information"){
                ...
                $('#foto').html(imagen);
                $("#hdHeadPanel").text("User Sports Information");
            }
    ...
    $("#subirportada").click(function(){
        ...
        $.ajax({
            ...
            ,success:function(respuesta){
                ...
                imagenCargada.src = "http://condominioagil.com/scouterzone/img/profiles/"+file.name;
